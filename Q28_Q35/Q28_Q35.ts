/* Q 28: Stages of Life: Write an if-let favourite_fruits: string[] = ["apple", "banana", "mango"];
...
}etermines a person’s stage of life. Set a value for the variable age, and then:
...
let usernames: string[] = ["atoofa", "admin", "zainab", "savera", "aamna"];
...
console.log("---------Q32----------");
let current_users: string[] = ["atoofa", "admin", "zainab", "savera", "aamna"];
let new_users: string[] = ["Atoofa", "ayesha", "Zainab", "savera", "amna"];

for (let new_user of new_users) {
  if (current_users.indexOf(new_user.toLowerCase()) !== -1) {
    console.log(
      "Sorry, the username " +
        new_user +
...
console.log("---------Q34----------");
let pizzas: string[] = ["pepperoni", "malai boti", "bbq chicken"];
